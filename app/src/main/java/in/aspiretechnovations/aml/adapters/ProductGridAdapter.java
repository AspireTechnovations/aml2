...
public class ProductGridAdapter extends RecyclerView.Adapter<ProductGridAdapter.ProductHolder> {
    ...
    public ProductHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_products_grid,parent,false);
